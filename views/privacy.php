...
<body>
    ...
    <div class="container my-5">
        ...
        <div class="card my-4">
            ...
            <div class="card-body">
                <p>Em caso de dúvidas sobre nossa política de privacidade ou para exercer seus direitos, entre em contato conosco através do e-mail <strong>contato@barbergo.com.br</strong>.</p>
            </div>
        </div>
    </div>
